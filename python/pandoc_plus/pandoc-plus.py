...
def process_file(path,output_extension,template):
    ...
    for input_file in input_files:
        ...
        if output_extension == 'pdf':
            s='pandoc "'+input_file+'" -s -t latex+smart --citeproc --data-dir='+pandoc_dir+' --template='+template+'.tex --pdf-engine=xelatex '+extractstring+'--wrap=none --reference-links -o "'+input_name+'.'+ output_extension+'"'
            ...
            s='pandoc "'+input_file+'" -s -t latex+smart --natbib --data-dir='+pandoc_dir+' --template='+template+'.tex --pdf-engine=xelatex '+extractstring+'--wrap=none --reference-links -o "'+input_name+'.'+ output_extension+'"'
