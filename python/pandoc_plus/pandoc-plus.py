...
def process_file(input_file_exp,output_extension,template):
    ...
    for input_file in input_files:
        ...
        if output_extension == 'pdf':
            ...
            s='pandoc "'+input_file+'" -s --wrap=none '+extractstring+' --atx-headers -t markdown-raw_html-bracketed_spans-native_spans-native_divs-fenced_divs -o "'+input_name+'.'+ output_extension+'"'
